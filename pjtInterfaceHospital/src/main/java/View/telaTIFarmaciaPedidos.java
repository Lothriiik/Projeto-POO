 ...
 * @author uande
 */
public class telaTIFarmaciaPedidos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        if (farTabela.getColumnModel().getColumnCount() > 0) {
            ...
            farTabela.getColumnModel().getColumn(1).setMinWidth(100);
            farTabela.getColumnModel().getColumn(1).setMaxWidth(100);
            farTabela.getColumnModel().getColumn(2).setMinWidth(150);
            farTabela.getColumnModel().getColumn(2).setMaxWidth(150);
        }
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        int l=mp1.getRowCount();
            ...
            try{
                ...
                while(rs.next()){
                    String   Coluna0=rs.getString("produto").toString().trim();
                    String   Coluna1=rs.getString("quantidade").toString().trim();
                    String   Coluna2=rs.getString("setor").toString().trim();
    ...
    private void pedidoentregueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pedidoentregueActionPerformed
       ...
       objpes.setProduto((String) farTabela.getValueAt(row,0));
       objpes.setQuantidade((String) farTabela.getValueAt(row,1));
       objpes.setSetor((String) farTabela.getValueAt(row,2));
       ...
       String setor=objpes.getSetor();
            ...
            try{
                    ...
                    if(Del.DeleteFarmaciaPedidos(produto,quantidade,setor)){

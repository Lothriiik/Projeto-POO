 ...
 * @author uande
 */
public class telaTIAlmoxarifadoPedidos extends javax.swing.JInternalFrame {
     ...
     */
    public telaTIAlmoxarifadoPedidos() {
        initComponents();
    }
    ...
    private void pedidoentregueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pedidoentregueActionPerformed
       ...
       objpes.setProduto((String) almTabela.getValueAt(row,0));
       objpes.setQuantidade((String) almTabela.getValueAt(row,1));
       objpes.setSetor((String) almTabela.getValueAt(row,2));
       ...
       String setor=objpes.getSetor();
            ...
            try{
                    ...
                    if(Del.DeleteAlmoxarifadoPedidos(produto,quantidade,setor)){

...
public class telaTIAlmoxarifadoPedidos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        if (almTabela.getColumnModel().getColumnCount() > 0) {
            ...
            almTabela.getColumnModel().getColumn(1).setPreferredWidth(40);
            almTabela.getColumnModel().getColumn(2).setMinWidth(100);
            almTabela.getColumnModel().getColumn(2).setMaxWidth(100);
            almTabela.getColumnModel().getColumn(3).setMinWidth(150);
            almTabela.getColumnModel().getColumn(3).setMaxWidth(150);
        }

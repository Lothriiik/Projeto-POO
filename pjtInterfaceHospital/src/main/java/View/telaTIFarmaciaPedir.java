 ...
 * @author uande
 */
public class telaTIFarmaciaPedir extends javax.swing.JInternalFrame {
    dadosFarmaciaPedidos objpes= new dadosFarmaciaPedidos();
    addEdit  AE;
    /**
     * Creates new form telaConsulta
     */
    public telaTIFarmaciaPedir() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        farSetor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", "Recepção", "TI", "Enfermaria", "Farmacia" }));
